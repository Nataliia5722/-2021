...
# 'Common Cold','Pneumonia','Геморрой',
# 'Heartattack','Varicoseveins','Гипотиреоз','Гипотиреоз','Гипогликемия','Остеоартроз',
...
# 'Common Cold':26,'Pneumonia':27,'Геморрой':28,'Острое сердечно-сосудистое заболевание':29,'Варикозное расширение вен':30,'Гипотиреоз':31,
# 'Гипотиреоз':32,'Гипогликемия':33,'Остеоартроз':34,'Артрит':35,
...
#
# def choose_symptom1():
#     returnValue = ListBoxChoice(root, "Symptom Picking", "Pick one of these symptoms",
#                                     l1).returnValue()
...
#
#
# lrLb = Label(root, text="Decision Tree")
# lrLb.grid(row=15, column=1, pady=10,sticky=W)
#
# destreeLb = Label(root, text="Random Forest")
# destreeLb.grid(row=17, column=1, pady=10, sticky=W)
#
# ranfLb = Label(root, text="Naive Bayes")
...
#
#
# S1En = Button(root, text="Choose", command=choose_symptom1)
# S1En.config(width=25)
# S1En.grid(row=7, column=1)
#
# S2En = Button(root, text="Choose", command=choose_symptom2)
# S2En.config(width=25)
# S2En.grid(row=8, column=1)
#
# S3En = Button(root, text="Choose", command=choose_symptom3)
# S3En.config(width=25)
# S3En.grid(row=9, column=1)
#
# S4En = Button(root, text="Choose", command=choose_symptom4)
# S4En.config(width=25)
# S4En.grid(row=10, column=1)
#
# S5En = Button(root, text="Choose", command=choose_symptom5)
...
# # TRAINING DATA tr --------------------------------------------------------------------------------
# tr=pd.read_csv("Testing.csv")
# tr.replace({'prognosis':{'Грибковые инфекции':0,'Аллергия':1,'Гастроэзофагеальный рефлюкс':2,'Хронический холестаз':3,'Реакция на лекарства':4,
# 'Язвенная болезнь':5,'ВИЧ':6,'Сахарный диабет ':7,'Гастроэнтерит':8,'Бронхиальная астма':9,'Гипертония ':10,
# 'Мигрень':11,'Шейный спондилез':12,
# 'Паралич (кровоизлияние в мозг)':13,'Желтуха':14,'Малярия':15,'Ветряная оспа':16,'Тропическая лихорадка':17,'Брюшной тиф':18,'Гепатит A':19,
# 'Гепатит B':20,'Гепатит C':21,'Гепатит D':22,'Гепатит E':23,'Алкогольный гепатит':24,'Туберкулез':25,
